...
export const hostname = () => {
  ...
  switch (window.location.hostname) {
    default:
      // hostUrl = 'https://api.blackgrandeurchauffeur.au';
      // hostUrl = 'http://localhost:5001';
      // hostUrl = 'http://192.168.0.242:5001';
      // hostUrl = 'http://127.0.0.1:5001';
      hostUrl = 'https://api-test.thedriverservices.com';
      // hostUrl = 'https://api.thedriverservices.com';
...
export const quickBooksRedirectUrl = 'https://app.sandbox.qbo.intuit.com'; //test sandbox url
